...
function ShopMenu:initializePages()
	...
	self.pageUsedSale:setCategory(GuiUtils.getUVs(ShopMenu.TAB_UV.SALE), nil, self.l10n:getText("ui_usedVehicleSale"), nil, nil, nil)
...
function ShopMenu:showCoinShop()
	...
	self:onClickItemCategory(ShopController.COINS_CATEGORY, nil, nil, self.l10n:getText("ui_coins"))
end
