...
function MotionPathEffect:update(dt)
	...
	if self.currentEffectNode ~= nil then
		self.motionPathEffectManager:setEffectShaderParameter(self.currentEffectNode, "scrollPosition", self.pathPosition, nil, nil, nil, false)
		self.motionPathEffectManager:setEffectShaderParameter(self.currentEffectNode, "prevScrollPosition", self.lastPathPosition, nil, nil, nil, false)
	...
	if sharedEffect ~= nil then
		...
		if self.currentEffectNode ~= nil then
			...
			if self.shapeScale ~= nil then
				self.motionPathEffectManager:setEffectShaderParameter(self.currentEffectNode, "sizeScale", self.shapeScale, nil, nil, nil, false)
			end

			if self.maxShapeScale ~= nil then
				self.motionPathEffectManager:setEffectShaderParameter(self.currentEffectNode, "sizeScale", nil, self.maxShapeScale, nil, nil, false)
			end

			if self.visibilityX ~= nil and #self.visibilityX == 2 then
				self.motionPathEffectManager:setEffectShaderParameter(self.currentEffectNode, "visibilityX", self.visibilityX[1], self.visibilityX[2], nil, nil, false)
			end

			if self.visibilityY ~= nil and #self.visibilityY == 2 then
				self.motionPathEffectManager:setEffectShaderParameter(self.currentEffectNode, "visibilityY", self.visibilityY[1], self.visibilityY[2], nil, nil, false)
			end

			if self.visibilityZ ~= nil and #self.visibilityZ == 2 then
				self.motionPathEffectManager:setEffectShaderParameter(self.currentEffectNode, "visibilityZ", self.visibilityZ[1], self.visibilityZ[2], nil, nil, false)
			end
