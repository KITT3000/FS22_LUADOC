...
g_gameVersion = 17
g_gameVersionNotification = "1.10.1.1"
g_gameVersionDisplay = "1.10.1.1"
...
function init(args)
	...
	local shopMenu = ShopMenu.new(nil, nil, g_messageCenter, g_i18n, g_inputBinding, g_fruitTypeManager, g_fillTypeManager, g_storeManager, shopController, g_shopConfigScreen, GS_IS_CONSOLE_VERSION, inAppPurchaseController)
	local constructionScreen = ConstructionScreen.new(nil, nil, g_i18n, g_messageCenter, g_inputBinding)
	...
	g_workshopScreen = WorkshopScreen.new(nil, nil, g_shopConfigScreen, g_messageCenter)
	...
	g_createGameScreen = CreateGameScreen.new(nil, nil, startMissionInfo)
	...
	g_gui:loadGui("dataS/gui/SettingsHDRFrame.xml", "SettingsHDRFrame", SettingsHDRFrame.new(nil, nil, settingsModel, g_i18n), true)
